...
export default function CommandPaletteModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-24 px-4 bg-slate-950/80 backdrop-blur-sm">
      <div className="w-full max-w-lg rounded-2xl border border-slate-200 dark:border-slate-850 bg-white dark:bg-slate-900 shadow-2xl overflow-hidden flex flex-col animate-scaleIn">
